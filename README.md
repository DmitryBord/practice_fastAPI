...
2. `pip install -r requirements.txt` - Устанавливаем все зависимости
3. `alembic upgrade head` - Запускаем миграции БД
4. `python -m spimex_app.main` - Запускаем парсер для наполнения БД данными (работа парсера около 10 минут)
...
5. Запускаем redis через докер:
   - `docker run -d --name redis -p 6379:6379 redis:7-alpine`
6. `python -m api_app.main` - Запускаем API приложение
